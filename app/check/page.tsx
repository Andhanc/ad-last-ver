  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // Автоматически генерируем и сохраняем итоговый PDF‑отчёт,
        // чтобы он сразу появился доступным в профиле (История финальных версий).
        try {
                            ...
                            onClick={async (e) => {
                              ...
                              try {
                                ...
                                const reportData = {
                                  ...
                                  uploadDate: new Date().toISOString(),
                                  // Отчёт всегда генерируем для финальной версии
                                  status: "final",
