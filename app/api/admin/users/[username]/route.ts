...
import { getUserByUsername, deleteUser, updateUserRole, readUsersDatabase, writeUsersDatabase } from "@/lib/user-storage"
...
export async function PUT(
  ...
  try {
    ...
    const { password, role, email, fullName, institution } = body
